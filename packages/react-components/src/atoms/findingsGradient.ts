import { info500, iris, colour } from '../colors';
...
const findingsRampStops = `${iris.hex} 30.25%, ${info500.hex} 51.91%, #1491B2 66.74%, #299C86 79.82%, ${colour.brand.crn[500].hex} 90.01%`;
