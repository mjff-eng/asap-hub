...
export { default as ExternalSpeakerAffiliationCard } from './ExternalSpeakerAffiliationCard';
...
export { default as SpeakerToast } from './SpeakerToast';
...
export type { AffiliationOption } from './ExternalSpeakerAffiliationCard';
